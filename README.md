...
PropTypes are proxy to warn the dev if they try to pass, for example, a number to a prop that actually expects a string. It's important to type check to eliminate any potential unexpected behavior or errors.

- [x] Describe a life-cycle event in React?

A life cycle event (method) runs at a certain point in the application's life span. `componentDidUpdate` will run when there has been an update to props/state. 

- [x] Explain the details of a Higher Order Component?

A HOC is a function that takes a component and returns a new one. Making it possible to reuse component logic.

- [x] What are three different ways to style components in React? Explain some of the benefits of each.

Standard CSS, LESS, or SASS, inline styles and styled components. It depends on the use case but outside of styled components I don't see the benefits of the others.
